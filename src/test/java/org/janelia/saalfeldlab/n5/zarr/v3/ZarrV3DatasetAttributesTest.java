...
public class ZarrV3DatasetAttributesTest {
	...
	public void builderTests() {
		...
		final ZarrV3DatasetAttributes defaultBlk = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32).build();
		assertArrayEquals(ZarrV3DatasetAttributes.defaultChunkShape(dims), defaultBlk.getBlockSize());

		// blockSize is reflected in output
		final ZarrV3DatasetAttributes withBlk = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
				.blockSize(blk).build();
		assertArrayEquals(blk, withBlk.getBlockSize());
		assertFalse(withBlk.isSharded());

		// fillValue is reflected
		final ZarrV3DatasetAttributes withFill = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
		...
		final ZarrV3DatasetAttributes withNames = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
		...
		final ZarrV3DatasetAttributes withSlash = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
				.blockSize(blk).dimensionSeparator("/").build();
		assertTrue(withSlash.relativeBlockPath(1, 2, 3).contains("/"));

		final ZarrV3DatasetAttributes withDot = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
				.blockSize(blk).dimensionSeparator(".").build();
		...
		final ZarrV3DatasetAttributes withEncoding = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
		...
		final ZarrV3DatasetAttributes withGzip = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
				.blockSize(blk).compression(new GzipCompression()).build();
		assertEquals(1, withGzip.getDataCodecInfos().length);

		final ZarrV3DatasetAttributes withRaw = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
		...
		final ZarrV3DatasetAttributes sharded = ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.UINT16)
		...
		final ZarrV3DatasetAttributes roundTrip = ZarrV3DatasetAttributes.zarr3Builder(withGzip).build();
		...
		try {
			ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32).blockSize(new int[]{32, 32}).build();
		...
		try {
			ZarrV3DatasetAttributes.zarr3Builder(dims, DataType.FLOAT32)
